  ...
  return (
    <div className="p-4">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-2 rounded-lg mb-3 text-sm font-medium transition-colors cursor-pointer bg-sky-50 text-sky-700 border border-sky-200 hover:bg-sky-100"
      >
        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
